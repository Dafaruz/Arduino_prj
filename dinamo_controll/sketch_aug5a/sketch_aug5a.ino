// ================================================
// Title: rpm control with hall efect 
// Date: October 8, 2024
// Author: daniel faruz
// ================================================
...
we had to check for the rpm noise its not working so good 
as far the next code will sample the distance between 2 shows 
